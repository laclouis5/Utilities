...
def parseXmlFiles(xml_path):
    xml_files = files_with_extension(xml_path, ".xml")
    ...
    for elem in root:
        ...
        for subelem in elem:
            ...
            if bndbox['xmin'] is not None:
                ...
                if labels_to_keep is None or (labels_to_keep is not None and object_name in labels_to_keep):
...
if __name__ == '__main__':
    ...
    labels_to_keep = ["mais", "haricot", "poireau", "mais_tige",
        "haricot_tige", "poireau_tige"]

    json_file = 'instances.json'
    for folder in folders:
        parseXmlFiles(os.path.join(base_path, folder))
